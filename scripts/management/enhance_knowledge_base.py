...
MANUAL_MAPPINGS = [
    ...
    {
        "cmd": "grep password /var/log/",
        "tech": "T1552.001",
        "name": "Unsecured Credentials: Credentials In Files",
    },
    {
        "cmd": "history | grep password",
        "tech": "T1552.003",
        "name": "Unsecured Credentials: Credentials In Bash History",
    },
    # -- Persistence --
    {
        "cmd": "echo >> .bashrc",
    ...
    with open(MAPPINGS_FILE, "w") as f:
        for m in MANUAL_MAPPINGS:
            entry = {
                ...
                "metadata": {"source": "manual_mapping", "confidence": 1.0, "verified": True},
            }
...
def rebuild_kb():
    ...
    manual_count = sum(
        1 for me in kb.command_metadata if me.get("metadata", {}).get("source") == "manual_mapping"
    )
