...
class ContextAnalyzer:
    ...
    def __init__(self):
        ...
        self.suspicious_tlds = {
            ...
            '.pw', '.cc', '.ws', '.info', '.click', '.loan', '.ru', '.cn'
        }
        
        # Suspicious keywords in URL
        self.url_keywords = {
            'malware', 'exploit', 'payload', 'backdoor', 'rootkit', 
            'trojan', 'rat', 'miner', 'botnet', 'ransomware',
            'reverse', 'shell', 'c2', 'exfil', 'hack'
        }
