...
class QuarantineService:
    ...
    async def save_file(self, filename: str, content: bytes, session_id: str = "unknown", src_ip: str = "unknown") -> Optional[str]:
        """
        ...
        try:
            ...
            if (current_size + content_size) > (self.quarantine_max_mb * 1024 * 1024):
                self.logger.log_event(session_id, "quarantine_warning", {
